...
export default function Process() {
  return (
    <div className="relative w-full h-full bg-[#0d0c0b] flex flex-col">
      {/* Blueprint grid bg */}
      <div
      ...
      <div className="relative z-10 flex flex-col h-full pt-20 md:pt-24 pb-6 px-6 md:px-14 lg:px-20 xl:px-24 max-w-[1400px] mx-auto w-full">
        ...
        {/* Steps grid — 2 cols × 3 rows on desktop, 1 col on mobile */}
        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 min-h-0">
          {steps.map((step, idx) => (
            <motion.div
              key={idx}
