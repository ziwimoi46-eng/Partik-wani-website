    ...
    <div className="relative w-full md:h-full min-h-screen bg-[#0a0908] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 flex">
          <div
            className="w-1/2 h-full bg-cover bg-center opacity-30"
      ...
      {/* Right accent image */}
      <div
        className="absolute right-0 top-0 bottom-0 w-[30%] md:w-[35%] bg-cover bg-center opacity-20 hidden md:block"
          ...
          <div className="flex flex-wrap items-center gap-6 md:gap-10 mb-7 pt-5 border-t border-white/8">
            {[
              ...
              <div key={stat.label} className="flex flex-col">
                <span className="text-2xl md:text-3xl font-serif text-primary leading-none mb-1">
                  {stat.value}
                </span>
